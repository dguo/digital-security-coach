...
const UBLOCK_ORIGIN_LINKS = [
    {browser: 'Chrome', link: 'https://chrome.google.com/webstore/detail/ublock-origin/cjpalhdlnbpafiamejdnhcphjbkeiagm'},
    {browser: 'Edge', link: 'https://www.microsoft.com/en-US/store/p/app/9nblggh444l4'},
    {browser: 'Firefox', link: 'https://addons.mozilla.org/en-US/firefox/addon/ublock-origin/'},
    {browser: 'Safari', link: 'https://github.com/el1t/uBlock-Safari/tree/safari/dist#install'}
];

const FIREFOX_FOCUS_LINKS = [
    {platform: 'Android', link: 'https://play.google.com/store/apps/details?id=org.mozilla.focus'},
...
const Action = () => {
    return [
        ...
        <Segment attached color="blue">
            ...
            <Container text>
                <p>
                    Have you ever seen something like this in your browser's
                    URL bar and wondered what it means?
                </p>

                <Image bordered src="https://upload.wikimedia.org/wikipedia/commons/e/e5/HTTPS_icon.png" size='small' />
                ...
                <p>
                    ...
                    or providing credit card information, it should be done
                    over HTTPS. A website that allows these activities over HTTP
                    is not secure. Take care to double check.
                </p>
        ...
        <Segment attached color="blue">
            ...
            <Container text textAlign="left">
                <p>
                    ...
                    way, making it harder for hackers to break into your
                    account because they need more than just your password. For
                    example, you might have to enter a code that is texted to
                    you. This may seem annoying, but you should at least use
                    it for particularly important accounts, like your email
                    account. Here are instructions for setting up two-step
                    authentication on some popular services:
                </p>
        ...
        <Segment attached color="blue">
            ...
            <Container text>
                <p>
                    ...
                    loading. Companies use trackers to collect data on
                    your browsing activity in order to serve targeted ads.
                    That's how you can view a product on one website and then
                    see ads for the same product on a totally different website
                    days later.
                </p>

                <p>
                    Blocking ads is good for security because ads can
                    be used to deliver viruses and other malicious software.
                    This technique is
                    called <a href="https://en.wikipedia.org/wiki/Malvertising">malvertising</a>.
                </p>

                <p>
                    Keep in mind that many content creators depend on
                    advertising for funding. If you do decide to use an ad
                    blocker, consider finding another way to support them,
                    such as purchasing a subscription. You can also disable the
                    ad blocker on a per-site basis.
                </p>
                ...
                <p>
                    You can install the
                    free <a href="https://github.com/gorhill/uBlock#ublock-origin">uBlock Origin</a> browser
                    extension.
                </p>
                ...
                <p>
                    You can use the free <a href="https://www.mozilla.org/en-US/firefox/focus/">Firefox Focus</a> browser.
                </p>
